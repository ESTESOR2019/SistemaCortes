...
Public Class SQLServer
    ...
    Public Overrides Function EjecutarSP(ByVal Nombre As String, ByVal ParamArray Parametros() As Object) As Integer
        Dim cant As Integer
        ...
        Try
            ...
            'El siguiente codigo se modifico debibo que el ExecuteNonQuery da error de verion, por lo tanto se realiza lo mismo que esta en el metodo Traer Datos'
            'Armo el DataAdapter
