...
#Region "Constructores y asignacion de valores a Instancias"
...
#Region "Funciones Principales de Clases"
    'OK
    ''' <summary>
    ...
    Public Function Insert(ByVal oNuevo As Object) As Object
        ...
        Try
            ...
            For Each propiedad As PropertyInfo In t.GetProperties(BindingFlags.Instance Or BindingFlags.Public Or BindingFlags.NonPublic)
                ...
                If Nullable.GetUnderlyingType(propiedad.PropertyType) <> Nothing Then
                    propiedad_tipo = Nullable.GetUnderlyingType(propiedad.PropertyType).Name
                End If
    ...
    Public Function Delete(ByVal ID As Integer) As Integer
        ...
        Catch ex As Exception
            ...
            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Error al Borrar."
            oErr.Exc_Message = ex.Message
            oErr.Exc_Source = "svr.Delete"
            Throw oErr
    ...
    Public Function ObtenerRegistro(ByVal _obj As Object, ByVal ID As Integer) As Object
        ...
        Catch ex As Exception
            oErr.Exc_Message = ex.Message
            oErr.Exc_Source = "svr.ObtenerResgistro"
            Throw oErr
        End Try
        Return _obj
    End Function
...
#Region "Funciones Secundarias de Clases"
    ...
    Public Shared Function ConvertDataTableToList(Of T)(ByVal dt As DataTable) As List(Of T)
        Dim dataList As List(Of T) = New List(Of T)()

        For Each row As DataRow In dt.Rows
            Dim item As T = CreateItemFromRow(Of T)(row)
            dataList.Add(item)
        Next
    ...
    ''' <returns></returns>
    Private Shared Function CreateItemFromRow(Of T)(ByVal row As DataRow) As T
        Dim item As T = Activator.CreateInstance(Of T)()

        For Each column As DataColumn In row.Table.Columns
            Dim [property] As PropertyInfo = GetType(T).GetProperty(column.ColumnName)

            If [property] IsNot Nothing AndAlso row(column) IsNot DBNull.Value Then
...
#Region "Funciones Principales en desuso"
    ...
    Private Function CMD_Execute(ByVal Conexion As String, oCmd As SqlCommand, ByVal query As String, Optional T_cmd As Tipo_Cmd = Tipo_Cmd.returnID) As Integer
        ...
        Catch ex As Exception
            ...
            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Error en el Execute."
            oErr.Exc_Message = ex.Message
            oErr.Exc_Source = "svr.CMD_Execute"
            Throw oErr
...
#Region "Funciones Principales de Procedimientos Almacenados"
    ...
    Public Overridable Function Agregar(ByVal ParamArray Parametros() As Object) As Integer
        ...
        Catch ex As Exception
            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Se produjo un Error al Agregar un registro."
            oErr.Exc_Message = ex.Message
            oErr.Exc_Source = "svr.Agregar"
            Throw oErr
        End Try
    ...
    Public Overridable Sub Eliminar(ByVal ParamArray Parametros() As Object)
        ...
        Catch ex As Exception
            ...
            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Se produjo un Error al Eliminar un registro."
            oErr.Exc_Message = ex.Message
            'oErr.Exc_Source = JsonConvert.SerializeObject(Parametros)
            oErr.Exc_Source = "svr.Eliminar"
            Throw oErr
    ...
    Public Overridable Sub Modificar(ByVal ParamArray Parametros() As Object)
        ...
        Try
            ...
            If cant <> 1 Then
                Throw New ApplicationException("No se encontró el Registro buscado")
            End If
        Catch ex As Exception
            'Throw New ApplicationException(Err_list("Error al Modificar", ex))

            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Se produjo un Error al Modificar un registro."
            oErr.Exc_Message = ex.Message
            'oErr.Exc_Source = JsonConvert.SerializeObject(Parametros)
            oErr.Exc_Source = "svr.Modificar"
            Throw oErr
    ...
    Public Overridable Function TraerUno(ByVal ParamArray Parametros() As Object) As System.Data.DataSet
        ...
        Catch ex As Exception
            ...
            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Se produjo un Error al ejecutar Obtener Uno de los registros (_OU)."
            oErr.Exc_Message = ex.Message
            'oErr.Exc_Source = JsonConvert.SerializeObject(Parametros)
            oErr.Exc_Source = "svr.TraerUno"
            Throw oErr
    ...
    ''' </summary>
    ''' <returns></returns>
    Public Overridable Function TraerTodos() As System.Data.DataSet
        Dim ds As Data.DataSet
        Try
            Dim srv As Servidor
            If m_Servidor Is Nothing Then
            ...
            ds = srv.TraerDatos(Tabla & "_OT")
        Catch ex As Exception
            'Throw New ApplicationException(Err_list("Error al ejecutar _OT", ex))
            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Se produjo un Error al ejecutar Traer Todos los registros."
            oErr.Exc_Message = ex.Message
            'oErr.Exc_Source = JsonConvert.SerializeObject(Parametros)
            oErr.Exc_Source = "svr.TraerTodos"
            Throw oErr
    ...
    Public Overridable Function Filtrado(ByVal ParamArray Parametros() As Object) As System.Data.DataSet
        ...
        Catch ex As Exception
            ...
            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Se produjo un Error al realizar el filtrado."
            oErr.Exc_Message = ex.Message
            ' oErr.Exc_Source = JsonConvert.SerializeObject(Parametros)
            oErr.Exc_Source = "svr.Filtrado"
            Throw oErr
    ...
    Public Overridable Function EjecutarSp(ByVal sp As String, ByVal ParamArray Parametros() As Object) As System.Data.DataSet
        ...
        Catch ex As Exception
            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Se produjo un Error al ejecutar Procedimiento Almacenado."
            oErr.Exc_Message = ex.Message
            'oErr.Exc_Source = JsonConvert.SerializeObject(Parametros)
            oErr.Exc_Source = "svr.EjecutarSp"
            Throw oErr
    ...
    'este se creó para un caso particular
    ''' <summary>
    ...
    Public Overridable Function EjecutarSpLIBRE_cs_usuario(ByVal sp As String, ByVal cString_de_usuario As String, ByVal ParamArray Parametros() As Object) As System.Data.DataSet
        ...
        Catch ex As Exception
            ...
            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Se produjo un Error al ejecutar Procedimiento Almacenado Libre con usuario de conexión."
            oErr.Exc_Message = ex.Message
            oErr.Exc_Source = "svr.EjecutarSpLIBRE_cs_usuario"
            Throw oErr
        End Try
        Return ds
    End Function
    ...
    Public Overridable Function EjecutarSpLIBRE(ByVal sp As String, ByVal ParamArray Parametros() As Object) As System.Data.DataSet
        ...
        Catch ex As Exception
            ' Throw New ApplicationException(Err_list("Error al ejecutar SpLIBRE", ex))
            Dim oErr As New cError()
            oErr.Exc_Client_msg = "Se produjo un Error al ejecutar Procedimiento Almacenado Libre"
            oErr.Exc_Message = ex.Message
            oErr.Exc_Source = "svr.EjecutarSpLIBRE"
            Throw oErr
        End Try
        Return ds
    End Function
...
#Region "Funciones Secundarias Generales"
...
#Region "Metodos agregados manualmente"
    Public Function CONSULTAR_POR_CAMPO_STRING(ByVal _Tabla As String, ByVal Campo As String, ByVal Valor As String, ByVal CampoClave As String, ByVal ValorClave As String) As Boolean
        Dim objConn As String = ""
        ...
        Try
            ...
            If ValorClave <> Nothing Or ValorClave <> 0 Then
                strSentencia = "Select * From " & _Tabla & " where flag_mostrar = 1 and " & Campo & " = '" & Valor & "' and " & CampoClave & " <> '" & CLng(ValorClave) & "'"
            Else
                strSentencia = "Select * From " & _Tabla & " where flag_mostrar = 1 and " & Campo & " = '" & Valor & "'"
            End If

            Dim da As New SqlDataAdapter(strSentencia, objConn)
    ...
    Public Function fnServicioDisponibleDB() As Boolean
        Try
            Dim connection = New SqlConnection(modConexion.ObtenerStringConexion(FuenteDatos))
            connection.Open()

            If ((connection.State & ConnectionState.Open) > 0) Then
                Return True
            Else
                Return False
            End If
