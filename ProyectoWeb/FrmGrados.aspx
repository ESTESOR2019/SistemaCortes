<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPager.Master" CodeBehind="FrmGrados.aspx.vb" Inherits="ProyectoWeb.FrmGrados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>
        <i class="fa fa-file-text-o icon-title"></i>Grados
    ...
    <div class="col-xs-12">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
                ...
                <asp:GridView ID="GdvGrados" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="grid aej_all table table-striped table-bordered dt-responsive dataTable no-footer"
