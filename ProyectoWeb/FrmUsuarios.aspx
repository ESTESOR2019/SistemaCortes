<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPager.Master" CodeBehind="FrmUsuarios.aspx.vb" Inherits="ProyectoWeb.FrmUsuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>
            <i class="fa fa-file-text-o icon-title"></i>Usuarios 
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    ...
                    <asp:GridView ID="GdvUsuarios" runat="server" AllowPaging="True" AutoGenerateColumns="true" CssClass="grid aej_all table table-striped table-bordered dt-responsive dataTable no-footer"
