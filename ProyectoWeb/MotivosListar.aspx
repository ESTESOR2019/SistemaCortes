<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPager.Master" CodeBehind="MotivosListar.aspx.vb" Inherits="ProyectoWeb.MotivosListar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <h1>
    <i class="fa fa-file-text-o icon-title"></i> Motivos 
            ...
            <div class="col-xs-12"> <%--COLUMNAS--%>
                <div class="box box-primary"> <%--CONTENEDOR--%>
                    ...
                    <div class="box-body table-responsive">
                         ...
                         <asp:GridView ID="GdvMotivos" runat="server"  AllowPaging="True" AutoGenerateColumns="False" CssClass="grid aej_all table table-striped table-bordered dt-responsive dataTable no-footer" 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabelAgregar">Agregar Motivos</h4>
                </div>
